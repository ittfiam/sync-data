drop table if exists tb_user_internal_region_manager;
CREATE TABLE `tb_user_internal_region_manager` (
  ...
  `province_code` varchar(8)  COMMENT '省编码',
  `province` varchar(256)  COMMENT '省名称',
  `city_code` varchar(8)  COMMENT '市编码',
  `city` varchar(256)  COMMENT '市名称',
  `region_code` varchar(8)  COMMENT '区编码',
  `region` varchar(256)  COMMENT '区名称',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='区域经理个人信息表'